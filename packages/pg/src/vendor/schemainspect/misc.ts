...
// Removed during sqlfu vendoring: `getResourceText` (was unused in
// schemainspect after the move to inline `queries.ts`). Kept the comment
// above for archaeological context.
