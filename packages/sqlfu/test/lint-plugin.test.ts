...
test('generated-query-freshness: reports a stale generated wrapper hash', async () => {
  const querySql = 'select id, name\nfrom users\norder by name;\n';
  await using project = await makeAsyncProject({
    'sqlfu.config.ts': `export default { queries: './sql' }`,
    'sql/list-users.sql': querySql,
    'sql/.generated/list-users.sql.ts': [
      '// Generated by `sqlfu generate`. Do not edit.',
      `// sqlfu-source-hash: ${'0'.repeat(64)}`,
      '',
      'export {};',
      '',
    ].join('\n'),
...
test('generated-query-freshness: reports a generated wrapper without source hash metadata', async () => {
  await using project = await makeAsyncProject({
    'sqlfu.config.ts': `export default { queries: './sql' }`,
    'sql/list-users.sql': 'select id, name\nfrom users\norder by name;\n',
...
test('generated-query-freshness: accepts a generated wrapper with a matching source hash', async () => {
  const querySql = 'select id, name\nfrom users\norder by name;\n';
  await using project = await makeAsyncProject({
    'sqlfu.config.ts': `export default { queries: './sql' }`,
    'sql/list-users.sql': querySql,
    'sql/.generated/list-users.sql.ts': [
      '// Generated by `sqlfu generate`. Do not edit.',
      `// sqlfu-source-hash: ${sha256(querySql)}`,
      '',
      'export {};',
      '',
    ].join('\n'),
