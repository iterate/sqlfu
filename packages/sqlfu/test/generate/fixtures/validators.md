Validator-integration fixtures: arktype and valibot. Runtime-behaviour tests
...
## validator: arktype + insert metadata skips result validation but keeps Params
...
export namespace insertPost {
	export type Params = typeof insertPost.Params.infer;
}
```
