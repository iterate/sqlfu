...
import { capitalize, convertToCamelCaseName, generateRelationType, removeDuplicatedParameters2, renameInvalidNames, TsDescriptor, writeNestedTypes, writeCollectFunction, writeGroupByFunction, createTypeNames, createCodeBlockWriter, writeDynamicQueryParamType, writeSelectFragements } from './shared/codegen-util.js';
import { CrudQueryType, PgDielect, QueryType, TsFieldDescriptor, TsParameterDescriptor, TypeSqlError } from '../types.js';
import { describeQuery } from '../postgres-query-analyzer/describe.js';
import { mapper } from '../dialects/postgres.js';
import { JsonArrayType, JsonFieldType, JsonMapType, JsonObjType, JsonType, PostgresType } from '../sqlite-query-analyzer/types.js';
import { okAsync, ResultAsync } from 'neverthrow';
import { getQueryName } from './sqlite.js';
import { mapToTsRelation2, RelationType2, TsField2 } from '../ts-nested-descriptor.js';
import { PostgresColumnInfo, PostgresParameterDef, PostgresSchemaDef } from '../postgres-query-analyzer/types.js';
import { PostgresSchemaInfo } from '../schema-info.js';
import { PostgresColumnSchema } from '../drivers/types.js';
import { writeBuildOrderByBlock, writeBuildSqlFunction, writeDynamicQueryOperators, writeMapToResultFunction, writeOrderByToObjectFunction, writeWhereConditionFunction } from './shared/codegen-util.js';
import { Field2 } from '../sqlite-query-analyzer/sqlite-describe-nested-query.js';
