...
we should probably introduce shadcn components for this since there's prior art for "Dialog" and similar. And while we're there we could add shadcn toast support too.
