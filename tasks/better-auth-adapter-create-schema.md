...
- [x] Make the fence markers explicit and boring. _The generated section uses generic `#region` / `#endregion` SQL comment markers with a Better Auth-specific region name._
