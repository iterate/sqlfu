...
//   .findMany({
//     where: sql`to_tsvector('english', ${customers.companyName}) @@ to_tsquery('english', ${sql.placeholder('term')})`,
//   })
//   .prepare();
...
//   .findMany({
//     where: sql`to_tsvector('english', ${products.name}) @@ to_tsquery('english', ${sql.placeholder('term')})`,
//   })
//   .prepare();
